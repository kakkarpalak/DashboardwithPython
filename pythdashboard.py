...
app.layout = html.Div([
   ...
   html.Div(id='output-container', className='chart-grid', style={'padding': 20})])
])
...
@app.callback(
   ...
   [Input(component_id='report-type', component_property='value'), Input(component_id='select-year', component_property='value')])
